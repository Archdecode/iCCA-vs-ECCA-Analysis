...
star_counts <- fread("C:/Users/navni/Downloads/star_counts_43samples_gene_by_sample.csv")

sample_meta_master <- fread("C:/Users/navni/Downloads/sample_meta_master (3).csv")
